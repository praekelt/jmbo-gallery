...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.content'
        db.add_column('gallery_gallery', 'content',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gallery.content'
    ...
    models = {
        ...
        'gallery.gallery': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'Gallery', '_ormbases': ['jmbo.ModelBase']},
        ...
        'gallery.galleryimage': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'GalleryImage', '_ormbases': ['gallery.GalleryItem']},
            'galleryitem_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['gallery.GalleryItem']", 'unique': 'True', 'primary_key': 'True'})
        },
        'gallery.galleryitem': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'GalleryItem', '_ormbases': ['jmbo.ModelBase']},
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gallery.Gallery']"}),
            'modelbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['jmbo.ModelBase']", 'unique': 'True', 'primary_key': 'True'})
        },
        'gallery.videoembed': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'VideoEmbed', '_ormbases': ['gallery.GalleryItem']},
            'embed': ('django.db.models.fields.TextField', [], {}),
            'galleryitem_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['gallery.GalleryItem']", 'unique': 'True', 'primary_key': 'True'})
        },
        'gallery.videofile': {
            'Meta': {'ordering': "('-created',)", 'object_name': 'VideoFile', '_ormbases': ['gallery.GalleryItem']},
